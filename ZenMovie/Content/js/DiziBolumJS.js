...
var guncelsezonno = $("#guncelsezonno").data("guncelsezonno");
var sezon;
...
$.ajax({
    type: 'Get',
    url: "/Dizi/Bolumler?id=" + diziid + "&sezonno=" + guncelsezonno ,
...
function buildEpisodes() {
    ...
    for (i = 0; i < myList.length; i++) {
        ...
        bolum = "<div class='col-6 col-sm-4 col-md-3 col-xl-2'><div class='card'><div class='card__cover'><img src=' " + myList[i].DiziResim + " ' width='150' height='200'><a class='card__play' href='/Dizi/Bolum?bid=" + myList[i].DiziBolumID + "&did=" + myList[i].DiziID + "&sezonno=" + myList[i].DiziBolumSezonNo + "'><i class='icon ion-ios-play'></i></a><span class='card__rate card__rate--green'>" + myList[i].IMDB + "</span></div><div class='card__content'><h3 class='card__title' title='" + baslik + "'><a>" + myList[i].DiziBolumBaslik + "</a></h3></div></div></div>"
