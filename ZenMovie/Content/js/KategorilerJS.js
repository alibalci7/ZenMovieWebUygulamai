...
function Goster() {
    var kriterler = "/Kategoriler/Index?secilenkategori=" + kategori + "&imdbbas=" + imdbbas.innerHTML + "&imdbson=" + imdbson.innerHTML + "&yilbas=" + yilbas.innerHTML + "&yilson=" + yilson.innerHTML;
